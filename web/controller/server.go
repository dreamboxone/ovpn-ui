...
func (a *ServerController) initRouter(g *gin.RouterGroup) {
	...
	g.GET("/checkUpdate", requirePanelUpdate, a.checkUpdate)
	...
	g.POST("/updatePanel", requirePanelUpdate, requireOverviewManage(), a.updatePanel)
	...
	g.POST("/uploadPanelBinary", requirePanelUpdate, requireOverviewManage(), a.uploadPanelBinary)
	g.POST("/fetchPanelBinary", requirePanelUpdate, requireOverviewManage(), a.fetchPanelBinary)
	g.POST("/applyPanelBinary", requirePanelUpdate, requireOverviewManage(), a.applyPanelBinary)
