...
func (s *Server) initRouter() (*gin.Engine, error) {
	...
	// platformJSON too: html/common/page.html is shared with the panel and calls it.
	engine.SetFuncMap(map[string]any{"i18n": i18nWebFunc, "platformJSON": service.PlatformJS})
